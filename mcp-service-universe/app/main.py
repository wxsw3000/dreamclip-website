...
logger = logging.getLogger("mcp-universe")
...
async def lifespan(app: FastAPI):
    ...
    logger.info("============================================================")
    yield
    logger.info("Universe service shutdown complete.")

app = FastAPI(
    title=settings.PROJECT_NAME,
    version=settings.VERSION,
    description="DreamClip 角色宇宙与内容中心：管理世界观大IP、角色档案、情绪胶囊原创图文及AVG章节元数据。",
    docs_url="/docs",
    redoc_url="/redoc",
...
def health():
    return {"status": "UP", "service": "dreamclip-service-universe", "code": 200}
