...
logger = logging.getLogger("dreamclip-service.register")
    ...
    try:
        async with httpx.AsyncClient(timeout=5.0) as client:
            ...
            if resp.status_code == 200:
                logger.info("Successfully registered dreamclip-service to MagicStarPlatform (%s)", settings.BASE_SERVICE_URL)
            else:
