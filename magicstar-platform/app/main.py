...
async def host_virtual_routing_middleware(request: Request, call_next):
    ...
    # 6. 业务主站路径智能代理转发 (梦之剧院场景、梦之厅、内容工坊、AVG游戏、胶囊阅读、合规页面)
    business_prefixes = ["/theater", "/scene", "/studio", "/capsule", "/character", "/games", "/game", "/about", "/privacy", "/terms", "/contact", "/universe", "/classic", "/hall"]
