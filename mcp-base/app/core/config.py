...
class Settings(BaseSettings):
    PROJECT_NAME: str = "MagicStar MCP 模块化配置平台 (Modular Configuration Platform)"
    VERSION: str = "1.0.0"
    ...
    # 数据库配置 (优先连接 MySQL mcp_base_db，失败自动回退 sqlite)
    MYSQL_USER: str = os.getenv("MYSQL_USER", "root")
    MYSQL_PASSWORD: str = os.getenv("MYSQL_PASSWORD", "19870404")
    MYSQL_HOST: str = os.getenv("MYSQL_HOST", "127.0.0.1")
    MYSQL_PORT: str = os.getenv("MYSQL_PORT", "3306")
    MYSQL_DB: str = os.getenv("MYSQL_DB", "mcp_base_db")
    ...
    SUPERADMIN_REAL_NAME: str = "MagicStar 巫星超管"
